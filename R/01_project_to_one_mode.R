...
#' @description Create a one-mode projection of a two mode graph. Converts a rectangular matrix to a square one by taking the cross product of the input matrix. The edge weights in the resulting matrix are equal to the number of transitive ties of each node in the input matrix.
...
#' @return A double or complex matrix, with appropriate dimnames taken from x and y.
#' @examples
#'#make matrix
